...
plt.savefig("Distance_Time_Plot.pdf")
plt.show()
...
# plotting https://www.geeksforgeeks.org/plot-line-graph-from-numpy-array/
fig2 = plt.figure()
speedste=fig2.add_subplot(111)
plt.title("Speed & Time") 
speedste.set_xlabel("Time (s)") 
speedste.set_ylabel("Speed (m/s)") 
speedste.plot(x1, y1, color ="red", lw=2) 
plt.savefig("Speed_Time_Plot.pdf")
plt.show()
fig2.suptitle("Plot Sample\n\n", fontweight ="bold")
#export as PDF